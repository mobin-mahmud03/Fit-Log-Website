        ...
        <div className="container mx-auto p-6 text-white relative">
            ...
            <div className="flex justify-between items-center mb-4">
                <div className="bg-[#14161d] p-1 rounded-lg border border-[#1a1d24] flex gap-1">
                    <button
                        onClick={() => setTab("plan")}
                        className={`px-4 py-1.5 text-xs font-bold rounded-md ${tab === "plan" ? "bg-[#222630] text-white" : "text-gray-400"
                            }`}
                    >
                        Today&apos;s Plan
                    </button>
                    <button
                        ...
                        className={`px-4 py-1.5 text-xs font-bold rounded-md ${tab === "saved" ? "bg-[#222630] text-white" : "text-gray-400"
                            }`}
                    >
                        Saved
                    </button>
            ...
            {list.length === 0 ? (
                <div className="text-center py-16">
                    ...
                    <Link
                        href="/#library"
                        className="inline-block bg-[#ccff00] text-black font-extrabold text-xs px-6 py-2.5 rounded-lg transition hover:opacity-90"
                    >
                        Browse Workouts
                    </Link>
                </div>
                        ...
                        return (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h3
                                            className={`font-extrabold text-sm uppercase ${isDone ? "line-through text-gray-500" : ""
                                                }`}
                                        >
                                            {item.name}
                                        </h3>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {tab === "plan" && (
                                        <button
                                            ...
                                            className={`font-extrabold text-xs px-3 py-1.5 rounded-full flex items-center gap-1 ${isDone
